	...
	<body dir="rtl">
		<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
			<defs>
				...
				<symbol xmlns="http://www.w3.org/2000/svg" id="xclose" width="40" height="40" viewbox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.29289 5.29289C5.68342 4.90237 6.31658 4.90237 6.70711 5.29289L12 10.5858L17.2929 5.29289C17.6834 4.90237 18.3166 4.90237 18.7071 5.29289C19.0976 5.68342 19.0976 6.31658 18.7071 6.70711L13.4142 12L18.7071 17.2929C19.0976 17.6834 19.0976 18.3166 18.7071 18.7071C18.3166 19.0976 17.6834 19.0976 17.2929 18.7071L12 13.4142L6.70711 18.7071C6.31658 19.0976 5.68342 19.0976 5.29289 18.7071C4.90237 18.3166 4.90237 17.6834 5.29289 17.2929L10.5858 12L5.29289 6.70711C4.90237 6.31658 4.90237 5.68342 5.29289 5.29289Z" fill="#0F1729"/><symbol>
		...
		<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
			<div class="offcanvas-body" >
				<button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
					<svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#arrow-right"></use></svg>
				</button>
				<ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
					<li class="nav-item border-dashed">
						<button class="btn btn-toggle dropdown-toggle position-relative w-100 d-flex justify-content-between align-items-center text-dark p-2" data-bs-toggle="collapse" data-bs-target="#food-collapse" aria-expanded="false">
						...
						<div class="collapse" id="food-collapse">
							<ul class="btn-toggle-nav list-unstyled fw-normal ps-5 pb-1">
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">زيوت</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">أجبان</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">لحوم</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">حبوب وبقوليات</a></li>
				                <li class="border-bottom py-2"><a href="index.html" class="dropdown-item">خضروات وفواكه</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">بهارات</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">أخرى</a></li>
							</ul>
						</div>
					</li>
					<li class="nav-item border-dashed">
						<button class="btn btn-toggle dropdown-toggle position-relative w-100 d-flex justify-content-between align-items-center text-dark p-2" data-bs-toggle="collapse" data-bs-target="#ready-collapse" aria-expanded="false">
							<div class="d-flex gap-3">
								<svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#pasta"></use></svg>
								<span>مأكولات جاهزة</span>
							</div>
						</button>
						<div class="collapse" id="ready-collapse">
							<ul class="btn-toggle-nav list-unstyled fw-normal ps-5 pb-1">
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">مخبوزات ومعجنات</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">حلويات</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">لحوم</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">مشويات</a></li>
				                <li class="border-bottom py-2"><a href="index.html" class="dropdown-item">طبيخ</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">أخرى</a></li>
							</ul>
						</div>
					</li>
					<li class="nav-item border-dashed">
						<button class="btn btn-toggle dropdown-toggle position-relative w-100 d-flex justify-content-between align-items-center text-dark p-2" data-bs-toggle="collapse" data-bs-target="#cloth-collapse" aria-expanded="false">
							<div class="d-flex gap-3">
								<svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#clothes"></use></svg>
								<span>ملابس</span>
							</div>
						</button>
						<div class="collapse" id="cloth-collapse">
							<ul class="btn-toggle-nav list-unstyled fw-normal ps-5 pb-1">
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">ملابس رجالية</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">ملابس نسائية</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">ملابس أطفال</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">اكسسوارات</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">أخرى</a></li>
							</ul>
						</div>
					</li>
					<li class="nav-item border-dashed">
						<button class="btn btn-toggle dropdown-toggle position-relative w-100 d-flex justify-content-between align-items-center text-dark p-2" data-bs-toggle="collapse" data-bs-target="#Perfume-collapse" aria-expanded="false">
							<div class="d-flex gap-3">
								<svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#perfume"></use></svg>
								<span>عطور</span>
							</div>
						</button>
						<div class="collapse" id="Perfume-collapse">
							<ul class="btn-toggle-nav list-unstyled fw-normal ps-5 pb-1">
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">عطور</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">بخور</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">مستلزمات نسائية</a></li>
								<li class="border-bottom py-2"><a href="index.html" class="dropdown-item">أخرى</a></li>
							</ul>
						</div>
					</li>
				...
				<div class="row py-3 border-bottom">
					...
					<div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
						<div class="d-flex align-items-center my-3 my-sm-0">
							<a href="index.html">
								<img src="images/newlogo.jpeg" alt="logo" class="img-fluid" width="90" height="90">
							</a>
						</div>
					...
					<div class="col-lg-4">
						<ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
							...
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle pe-3" role="button" id="pages" data-bs-toggle="dropdown" aria-expanded="false">الصفحات</a>
									<ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
										<li><a href="index.html" class="dropdown-item">عن الموقع </a></li>
										<li><a href="index.html" class="dropdown-item">اتصل بنا </a></li>
									</ul>
							</li>
						</ul>
					</div>
					...
					<?php
						...
						if (isset($_GET['logout'])) {
							...
							//$user_id = null; // Reset the user_id variable
							echo '<script>document.cookie = "user_id=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;"; window.location.href = "index.php";</script>';
							exit;
						}
					...
					<div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
						<ul class="d-flex justify-content-end list-unstyled m-0">
							<?php if ($user_id) { ?>
								<a class="nav-link dropdown-toggle pe-3" role="button" id="profile" data-bs-toggle="dropdown" aria-expanded="false">الحساب</a>
									<ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="profile">
										<li><a href="profile.php" class="dropdown-item">الملف الشخصي </a></li>
										<li><a href="?logout=1" class="dropdown-item">تسجيل الخروج </a></li>
									</ul>
							<?php } else { ?>
								<li>
									<a href="login/login.html" class="p-2 mx-1">
